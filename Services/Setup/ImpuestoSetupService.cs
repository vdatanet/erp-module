...
public class ImpuestoSetupService(IObjectSpace objectSpace)
{
    ...
    {
        CreateIfMissingTipoImpuesto("IVA21", "IVA 21%", 21, true, true, Impuesto.IVA);
        CreateIfMissingTipoImpuesto("IVA10", "IVA 10%", 10, true, true, Impuesto.IVA);
        CreateIfMissingTipoImpuesto("IVA4", "IVA 4%", 4, true, true, Impuesto.IVA);
        CreateIfMissingTipoImpuesto("EXENTO", "Exento", 0, true, true, Impuesto.IVA);
    }

    private void CreateIfMissingTipoImpuesto(string codigo, string nombre, decimal tipo, bool enVentas, bool enCompras,
