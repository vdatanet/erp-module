...
public class CuentaSetupService(IObjectSpace objectSpace)
{
    ...
    private void CreatePgcEspanol()
    {
        ...
        CreateCuenta("47221", "HP IVA soportado 21%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4722100000", "HP IVA soportado 21%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("47210", "HP IVA soportado 10%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4721000000", "HP IVA soportado 10%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("47204", "HP IVA soportado 4%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4720400000", "HP IVA soportado 4%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("47200", "HP IVA soportado 0%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4720000000", "HP IVA soportado 0%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("47252", "HP RE soportado 5,2%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4725200000", "HP RE soportado 5,2%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("47214", "HP RE soportado 1,4%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4721400000", "HP RE soportado 1,4%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("47205", "HP RE soportado 0,5%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4720500000", "HP RE soportado 0,5%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("473", "HP Retenciones y pagos a cuenta", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("47315", "HP Retenciones Soportadas Prof. 15%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4731500000", "HP Retenciones Soportadas Prof. 15%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("47307", "HP Retenciones Soportadas Prof. 7%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4730700000", "HP Retenciones Soportadas Prof. 7%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        CreateCuenta("47319", "HP Retenciones Soportadas Alquileres 19%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora);
        CreateCuenta("4731900000", "HP Retenciones Soportadas Alquileres 19%", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        ...
        CreateCuenta("47515", "HP acreedora Retenciones IRPF 15%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4751500000", "HP acreedora Retenciones IRPF 15%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        CreateCuenta("47507", "HP acreedora Retenciones IRPF 7%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4750700000", "HP acreedora Retenciones IRPF 7%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        CreateCuenta("47519", "HP acreedora Retenciones IRPF 19%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4751900000", "HP acreedora Retenciones IRPF 19%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        ...
        CreateCuenta("47721", "HP IVA repercutido 21%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4772100000", "HP IVA repercutido 21%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        CreateCuenta("47710", "HP IVA repercutido 10%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4771000000", "HP IVA repercutido 10%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        CreateCuenta("47704", "HP IVA repercutido 4%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4770400000", "HP IVA repercutido 4%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        CreateCuenta("47700", "HP IVA repercutido 0%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4770000000", "HP IVA repercutido 0%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        CreateCuenta("47752", "HP RE repercutido 5,2%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4775200000", "HP RE repercutido 5,2%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        CreateCuenta("47714", "HP RE repercutido 1,4%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4771400000", "HP RE repercutido 1,4%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        CreateCuenta("47705", "HP RE repercutido 0,5%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora);
        CreateCuenta("4770500000", "HP RE repercutido 0,5%", Cuenta.TipoCuenta.Pasivo, Cuenta.NaturalezaCuenta.Acreedora, true);
        ...
        CreateCuenta("5720000000", "Bancos e instituciones de crédito c/c - Cuenta principal", Cuenta.TipoCuenta.Activo, Cuenta.NaturalezaCuenta.Deudora, true);
        ...
        CreateCuenta("6000000000", "Compras de mercaderías - Nacionales", Cuenta.TipoCuenta.Gastos, Cuenta.NaturalezaCuenta.Deudora, true);
        ...
        CreateCuenta("7000000000", "Ventas de mercaderías - Nacionales", Cuenta.TipoCuenta.Ingresos, Cuenta.NaturalezaCuenta.Acreedora, true);
        ...
        CreateCuenta("7050000000", "Prestaciones de servicios (euros)", Cuenta.TipoCuenta.Ingresos, Cuenta.NaturalezaCuenta.Acreedora, true);
